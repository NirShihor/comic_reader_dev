...
struct ComicDetailView: View {
    ...
    private var cockpitText: String {
        switch cockpitStep {
        case 1: return "This is the language learning cockpit. Decide if you want to simply read and listen, or practise with any of the different practice modes. It is recommended to read and listen to the comic at least once before starting to practise."
